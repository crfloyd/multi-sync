  ...
  return (
    <main>
      ...
      <section
        ...
        items-center !overflow-visible rounded-md bg-neutral-950 antialiased'
      >
        ...
        <div className='mt-[-100px] flex flex-col md:mt-[-50px]'>
          <ContainerScroll
            titleComponent={
              // Add a mb-20 here to put some space between the title and the image
              <div className='flex flex-col items-center'>
                ...
                <h1 className='bg-gradient-to-b from-white  to-neutral-600 bg-clip-text font-sans text-5xl font-bold text-transparent md:mb-3 md:text-8xl'>
                  Automate Your Life With MultiSync
                </h1>
              </div>
            }
          />
        ...
        <div className='-mt-72 flex flex-col flex-wrap items-center justify-center gap-8 md:flex-row'>
          <CardContainer className='inter-var '>
            <CardBody className='group/card relative h-auto  w-full rounded-xl border border-black/[0.1] bg-gray-50 p-6 dark:border-white/[0.2] dark:bg-black dark:hover:shadow-2xl dark:hover:shadow-neutral-500/[0.1] md:!w-[350px]'>
              ...
              >
                Dive into automation with our free, foundational plan. Perfect
          ...
          <CardContainer className='inter-var '>
            <CardBody className='group/card relative h-auto  w-full rounded-xl border border-black/[0.1] bg-gray-50 p-6 dark:border-[#E2CBFF] dark:bg-black dark:hover:shadow-2xl dark:hover:shadow-neutral-500/[0.1] md:!w-[350px]'>
              ...
              <CardItem
                ...
                className='mt-2 max-w-sm text-sm text-neutral-500 dark:text-neutral-300'
              >
                Elevate your efficiency with advanced features. Ideal for
                professionals seeking to streamline their workflows.
                <ul className='my-4 flex flex-col gap-2'>
                  <li className='flex items-center gap-2'>
                    <CheckIcon />
                    50 Free automations
          ...
          <CardContainer className='inter-var '>
            <CardBody className='group/card relative h-auto  w-full rounded-xl border border-black/[0.1] bg-gray-50 p-6 dark:border-white/[0.2] dark:bg-black dark:hover:shadow-2xl dark:hover:shadow-neutral-500/[0.1] md:!w-[350px]'>
              ...
              <CardItem
                ...
                className='mt-2 max-w-sm text-sm text-neutral-500 dark:text-neutral-300'
              >
                Unlock ultimate power and flexibility. Our comprehensive
                solution for professionals or businesses ready to dominate
                through automation.
                <ul className='my-4 flex flex-col gap-2'>
                  <li className='flex items-center gap-2'>
                    <CheckIcon />
